    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-7xl mx-auto px-8 py-8">
        <nav className="text-[13px] text-[#6B7280] mb-8">
          <Link to="/" className="hover:text-[#2E6DA4]">Busca</Link>
          {' > '}
          <Link to="/resultados?q=computadores&mode=semantica" className="hover:text-[#2E6DA4]">Resultados</Link>
          {' > '}
          ...
          <div className="flex-1">
            ...
            <div className="bg-[#F5F7FA] rounded-lg p-6 mb-8">
              ...
              <div className="grid grid-cols-2 gap-6">
                <div>
                  ...
                  <div className="text-[16px] text-[#111827]">Secretaria de Administração do Estado da Bahia</div>
                </div>
                <div>
                  <div className="text-[13px] text-[#6B7280] mb-1">Unidade administrativa</div>
                  <div className="text-[16px] text-[#111827]">Diretoria de Tecnologia da Informação</div>
                </div>
                <div>
            ...
            <div className="bg-white border border-[#E2E8F0] rounded-lg p-6 mb-8">
              ...
              <p className="text-[16px] text-[#111827] leading-relaxed">
                Aquisição de equipamentos de informática, incluindo notebooks, monitores, teclados, mouses e estabilizadores,
                destinados à modernização do parque tecnológico da Secretaria de Administração do Estado da Bahia, visando
                atender às demandas operacionais e melhorar a qualidade dos serviços prestados à população. Os equipamentos
                deverão atender às especificações técnicas mínimas estabelecidas no Termo de Referência.
              </p>
            </div>
              ...
              <div className="overflow-x-auto">
                <table className="w-full text-[13px]">
                  <thead className="bg-[#F5F7FA]">
                    <tr>
                      <th className="px-4 py-3 text-left text-[#111827] font-medium">Nº</th>
                      <th className="px-4 py-3 text-left text-[#111827] font-medium">Descrição</th>
                      <th className="px-4 py-3 text-left text-[#111827] font-medium">Quantidade</th>
                      <th className="px-4 py-3 text-left text-[#111827] font-medium">Unidade</th>
                      <th className="px-4 py-3 text-left text-[#111827] font-medium">Valor unitário</th>
                    </tr>
                  </thead>
